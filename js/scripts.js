document.addEventListener('DOMContentLoaded', function(){
	...
	if ($('canvas').is('#amount-chart')){
		...
		gradient_1.addColorStop(0, 'rgba(0,119,187,1)');
		gradient_1.addColorStop(1, 'rgba(0,119,187,1)');

		let gradient_2 = ctx.createLinearGradient(0, 0, 0, 400);
		gradient_2.addColorStop(0, 'rgba(0,119,187,1)');
		gradient_2.addColorStop(1, 'rgba(0,119,187,1)');
